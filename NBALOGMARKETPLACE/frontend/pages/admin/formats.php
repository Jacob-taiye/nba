...
$activePage = 'formats';
$items = $pdo->query('SELECT * FROM formats ORDER BY created_at DESC')->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Formats — Admin</title>
  ...
  <div class="dash-main">
    <div class="topbar">
      ...
      <div class="topbar-right">
        <button class="add-btn" onclick="openAdd()"><i class="fas fa-plus"></i> Add Format</button>
    ...
    <div class="dash-content">
      <div class="section-card">
        <div class="section-card-header">
          <div class="section-card-title"><i class="fas fa-file-lines"></i> All Formats <span class="count-badge"><?= count($items) ?></span></div>
        </div>
              ...
              <tr id="row<?= $item['id'] ?>">
                ...
                <td>
                  <div style="display:flex;gap:6px">
                    ...
                    <button class="act-btn del" onclick="doDelete(<?= $item['id'] ?>,'format')"><i class="fas fa-trash"></i></button>
                  </div>
                </td>
              </tr>
              <?php endforeach; ?>
              <?php if(empty($items)): ?><tr><td colspan="6" class="empty-td">No formats yet. Click "Add Format" to get started.</td></tr><?php endif; ?>
            </tbody>
          </table>
        </div>
      </div>
...
<div class="modal-overlay" id="itemModal">
  <div class="modal-box">
    <div class="modal-head">
      <div class="modal-title" id="modalTitle">Add Format</div>
    ...
    <button class="save-btn" id="saveBtn" onclick="saveItem('format')">
